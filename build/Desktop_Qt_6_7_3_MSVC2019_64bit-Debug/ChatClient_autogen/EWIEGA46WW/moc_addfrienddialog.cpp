...
struct qt_meta_stringdata_CLASSFriendResultItemENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFriendResultItemENDCLASS = QtMocHelpers::stringData(
    "FriendResultItem"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFriendResultItemENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FriendResultItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFriendResultItemENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFriendResultItemENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFriendResultItemENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FriendResultItem, std::true_type>
    >,
    nullptr
} };
...
void *FriendResultItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFriendResultItemENDCLASS.stringdata0))
...
constexpr auto qt_meta_stringdata_CLASSAddFriendDialogENDCLASS = QtMocHelpers::stringData(
    "AddFriendDialog"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
